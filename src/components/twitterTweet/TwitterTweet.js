  ...
  return (
    <blockquote className="twitter-tweet">
      <p lang="es" dir="ltr">Un grupo de alumnos del centro educativo de San Cristóbal, en <a href="https://twitter.com/hashtag/LasPalmasdeGranCanaria?src=hash&amp;ref_src=twsrc%5Etfw">#LasPalmasdeGranCanaria</a>,
        ...
        <br />
        <br />Los primeros en disfrutar de este
        <a href="https://twitter.com/hashtag/turismo?src=hash&amp;ref_src=twsrc%5Etfw">#turismo</a>
        marinero piloto han sido estudiantes daneses de
        <a href="https://twitter.com/hashtag/Erasmus?src=hash&amp;ref_src=twsrc%5Etfw">#Erasmus</a>
